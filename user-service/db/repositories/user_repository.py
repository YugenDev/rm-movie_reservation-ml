...
class UserRepository:
    ...
    def update_user(self, db: Session, user_id: str, user: UserUpdateSchema):
        ...
        if existing_user.role == "user" and user.role is not None:
            raise HTTPException(status_code=status.HTTP_403_FORBIDDEN, detail="You do not have permission to change your role")
        try:
